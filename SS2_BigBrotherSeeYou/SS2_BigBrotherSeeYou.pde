...
//Title:Big Brother See You 
//By: Cordell Lane
//part2 add on to my sketch

int d = 2;
float R = random(255);
float G = random(255);
float B = random(255);
int s = int(random(1,255));
...
//when you move the mouse to one side of the screen the ring should change color
if(mouseX > width/2){
   fill(20, 75, 200);
   ellipse(450,350,450,450);
}
